...
namespace UtilEx
{
    ...
    public class PropertyAccessor : IPropertyAccessor
    {
        ...
        public PropertyAccessor(Type targetType, string property)
        {
            ...
            {
                throw new
                  ArgumentException(string.Format("Property \"{0}\" does" +
        ...
        private Dictionary<Type, OpCode> _typeCodes;
        ...
        {
            _typeCodes = new Dictionary<Type, OpCode>();
            _typeCodes[typeof(sbyte)] = OpCodes.Ldind_I1;
            _typeCodes[typeof(byte)] = OpCodes.Ldind_U1;
            _typeCodes[typeof(char)] = OpCodes.Ldind_U2;
            _typeCodes[typeof(short)] = OpCodes.Ldind_I2;
            _typeCodes[typeof(ushort)] = OpCodes.Ldind_U2;
            _typeCodes[typeof(int)] = OpCodes.Ldind_I4;
            _typeCodes[typeof(uint)] = OpCodes.Ldind_U4;
            _typeCodes[typeof(long)] = OpCodes.Ldind_I8;
            _typeCodes[typeof(ulong)] = OpCodes.Ldind_I8;
            _typeCodes[typeof(bool)] = OpCodes.Ldind_I1;
            _typeCodes[typeof(double)] = OpCodes.Ldind_R8;
            _typeCodes[typeof(float)] = OpCodes.Ldind_R4;
        }
        ...
        private Assembly EmitAssembly()
        {
            ...
            if (targetSetMethod != null)
            {
                ...
                if (paramType.IsValueType)
                {
                    ...
                    if (_typeCodes[paramType] != null) //and load
                    {
                        OpCode load = (OpCode)_typeCodes[paramType];
                        setIL.Emit(load);
                    }
                    else
                    {
